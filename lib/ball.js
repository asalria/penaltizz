...
Ball.prototype.reduce = function(){
    ...
    var y = this.y;
    var img = this.img;
    this.finalImH = (this.finalImH - this.stren/580) > 0 ? (this.finalImH - this.stren/580) : 0;
    this.finalImW = (this.finalImW - this.stren/580) > 0 ? (this.finalImW - this.stren/580) : 0;
    this.ctx.drawImage(img, x+this.stren/580, y+this.stren/580, this.finalImW, this.finalImH);
}
